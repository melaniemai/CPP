...
public:
  ...
  myComplex conjugate();
  myComplex addition(const myComplex& right) const;
  myComplex subtraction(const myComplex& right) const;
  myComplex multiplication(const myComplex& right) const;
  myComplex division(const myComplex& right) const;
